...
export class VideoPlayerComponent implements OnInit {
  ...
  loadedModels: boolean | undefined;
  overlay: boolean | undefined;
  filterSelect: any;
  public listSubscribers: any = [];
  previewCanvas: any;
  currentExp: string | undefined;
  drawing = true;
  filters = [
    {
      type: 'question',
  ...
  drawAi = (_resizedDetections: any, displaySize: { width: number; height: any; }, eyes: { left: { x:number, y: number; }[]; }) => {
